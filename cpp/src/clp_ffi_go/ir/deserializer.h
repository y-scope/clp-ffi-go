#ifndef CLP_FFI_GO_IR_DESERIALIZER_H
#define CLP_FFI_GO_IR_DESERIALIZER_H
 ...
 * @param[in] ir_span Byte span containing CLP IR
 * @param[out] ir_pos Position in ir_span read to
 ...
 * @param[out] metadata_pos Position in ir_span where the metadata begins
...
#endif  // CLP_FFI_GO_IR_DESERIALIZER_H
