 ...
 */
CLP_FFI_GO_METHOD void* ir_decoder_new();
 ...
 *   ir_decoder_new
 */
CLP_FFI_GO_METHOD void ir_decoder_close(void* decoder);
 ...
 */
CLP_FFI_GO_METHOD int ir_decoder_decode_eight_byte_log_message(
        StringView logtype,
        Int64tSpan vars,
 ...
 * @return ffi::ir_stream::IRErrorCode_Success on success
 */
CLP_FFI_GO_METHOD int ir_decoder_decode_four_byte_log_message(
        StringView logtype,
        Int32tSpan vars,
        StringView dict_vars,
        Int32tSpan dict_var_end_offsets,
